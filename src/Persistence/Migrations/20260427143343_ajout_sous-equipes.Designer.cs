...
namespace Persistence.Migrations
{
    ...
    [Migration("20260427143343_ajout_sous-equipes")]
    partial class ajout_sousequipes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.AdminAvailability", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Domain.Entities.MemberEquipe", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("MemberId", "EquipeId")
                        .IsUnique();

                    b.ToTable("MemberEquipes");
                });
            ...
            modelBuilder.Entity("Domain.Entities.QuizQuestion", b =>
                {
                    ...
                    b.Property<string>("ScaleMidLabel")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entities.UserQuizResponse", b =>
                {
                    ...
                    b.Property<string>("SelectedTextResponse")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entities.Equipe", b =>
                {
                    b.HasOne("Domain.Entities.Equipe", "ParentEquipe")
                        .WithMany("SousEquipes")
            ...
            modelBuilder.Entity("Domain.Entities.Equipe", b =>
                {
                    b.Navigation("MemberEquipes");

                    b.Navigation("SousEquipes");
                });
