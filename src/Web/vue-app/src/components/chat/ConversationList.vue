<template>
  <div class="flex-1 flex flex-col overflow-hidden">
    <!-- Search -->
    <div v-if="!loading && chatStore.conversations.length > 0" class="px-4 py-3 border-b border-gray-100">
      <div class="relative">
      ...
      <div v-else>
        ...
        >
          ...
          <div class="flex-1 min-w-0">
            ...
            <p class="text-xs text-gray-500 truncate mt-0.5">{{ conv.lastMessage || $t('chat.noMessages') }}</p>
          </div>
